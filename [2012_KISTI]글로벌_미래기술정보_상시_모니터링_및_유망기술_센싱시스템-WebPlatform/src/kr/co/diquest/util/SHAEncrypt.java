...
public class SHAEncrypt {
	...
	public static void main(String[] args) {
		...
		System.out.println(SHAEncrypt.getEncrypt("gpass1~"));
		System.out.println(SHAEncrypt.getEncrypt("coreawin"));
		System.out.println(SHAEncrypt.getEncrypt("kisti"));
		System.out.println(SHAEncrypt.getEncrypt("neon"));
	}
}

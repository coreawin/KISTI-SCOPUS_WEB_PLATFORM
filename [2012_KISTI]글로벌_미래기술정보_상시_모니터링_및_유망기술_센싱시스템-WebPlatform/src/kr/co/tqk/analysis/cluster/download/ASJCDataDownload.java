 ...
 * 
 */
public class ASJCDataDownload extends IDataDownload {
	
	LinkedHashMap<String, String> asjcInfo = new LinkedHashMap<String, String>();

	public ASJCDataDownload(int year, float ranking, int _dataType,
			LinkedHashMap<String, String> asjcInfo, String saveFilePath) {
		this(year, Calendar.getInstance().get(Calendar.YEAR), ranking, _dataType, asjcInfo, saveFilePath);
	}
	
	public ASJCDataDownload(int fromYear, int toYear, float ranking, int _dataType,
			LinkedHashMap<String, String> asjcInfo, String saveFilePath) {
		this.fromYear = fromYear;
		this.toYear = toYear;
		this.ranking = ranking;
		this.asjcInfo = asjcInfo;
	...
	public void download() throws SQLException {
		...
		try {
			...
			String query = "";
			for (String key : asjcInfo.keySet()) {
				String asjcWhereCondition = asjcInfo.get(key);
				...
				System.out.println("======== Execute ASJC Data Type ========== " );

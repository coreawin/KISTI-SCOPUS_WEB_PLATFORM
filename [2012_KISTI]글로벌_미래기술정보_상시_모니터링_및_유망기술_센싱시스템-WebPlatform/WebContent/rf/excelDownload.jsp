...
<%@page import="kr.co.topquadrant.db.bean.ClusterDocumentExcelExport"%>
...
<%
	...
	String fileName = session.getId() + ".xlsx";
	String templateFileName = modelPath + "TemplateExportCluster.xlsx";
	String outputFileName = tmpSavePath + fileName;
...
try{
	...
	response.reset();
	String file_name = outputFileName;
	String file_path = tmpSavePath;
	 ...
	 */
	 ...
	 if (request.getHeader("User-Agent").indexOf("MSIE 5.5") > -1) { // MS IE 5.5 이하
       ...
       response.setHeader("Content-Disposition", "attachment; filename=clusterExport.xlsx;");

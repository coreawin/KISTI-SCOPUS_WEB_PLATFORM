...
<script type="text/javascript">
	...
	function registerCluster(){
		...
		form.method="POST";
		form.action = "./analysisRegistProc.jsp";
		form.submit();
	}
		...
		<div id="content">
            ...
            <table class="Table9" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <td colspan="2" style="padding:2px 2px 2px 2px;">
                    	<span class="txt7" style="text-shadow: 1px 1px 2px #999; margin-left: 10px" >New Cluster Analysis</span>
                    </td>
                </tr>
       	  		<tr height="40">
                    <td style="padding:2px 5px 2px 20px; text-align: right;" width="100">Title</td>
                    <td style="padding:2px 5px 2px 5px;"><input type="text" name="title" maxlength="512" style="width: 97%;"/></td>
                </tr>
       	  		<tr height="40">
                    <td style="padding:2px 5px 2px 20px; text-align: right; vertical-align: top;">Description</td>
                    <td style="padding:2px 5px 2px 5px;"><textarea rows="5" name="description" style="width: 98%; word-wrap:break-word;"></textarea></td>
                </tr>
       	  		<tr height="40">
                    ...
                    <td style="padding:2px 5px 2px 5px;">
                    	<table>
                    		<tr>
                    			<td width="50%">
			                        <input type="checkbox" name="addScience" value="<%=MyBatisParameter.Y%>"/> Include Papers in Science (Recent 5 years) <br> 
			                        <!-- 
			                        ...
			                        <input type="checkbox" name="addScience" value="<%=MyBatisParameter.R%>"/> Science 출처에 대한 관련논문 (최근 5년 이후)
			                         -->
			                        <input type="checkbox" name="addNature" value="<%=MyBatisParameter.Y%>"/> Include Papers in Nature (Recent 5 years) <br>
			                        <!-- 
                    ...
                    <td colspan="2" style="padding:2px 17px 2px 20px; text-align: right; vertical-align: middle;">
                        <div id="submit">
							<input type="button" value="Add New Cluster Analysis" class="bt4" title="클러스터를 등록합니다." onclick="javascript:registerCluster();">
                        </div>
                    </td>
                </tr>
            </table> 

...
<script type="text/javascript" src="<%=contextPath%>/js/custom-form-elements.js"></script>
...
$(document).ready(function() {
    ...
    $("#tableList").jqGrid({ 
		//url: 'asjc.json', 
		url: '../hcp/hcpMainData.jsp?ranking=<%=ranking%>&largeAsjc=<%=largeAsjc%>', 
		datatype: 'json', 
		mtype: 'POST',
		formatter : {
    ...
    $("#tableList").jqGrid('navButtonAdd','#pager',{
        caption:"Export to Excel", 
        onClickButton : function () { 
            jQuery("#tableList").jqGrid('excelExport',{tag:'excel', url:'excel.jsp?startYear=<%=startYear%>&endYear=<%=endYear%>&ranking=<%=ranking%>&largeAsjc=<%=largeAsjc%>&externalUse=false'});
        } 
    });
                ...
                <tr>
                	<td>
                        <table cellspacing="5" cellpadding="5" border="0" width="100%">
                        	...
                        	<tr>
                        		<td class="txt1" style="text-align: left; vertical-align: bottom;" >

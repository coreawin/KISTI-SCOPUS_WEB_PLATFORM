...
DROP TABLE B_SCOPUS_DOCUMENT CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_DOCUMENT(
...
DROP TABLE B_SCOPUS_DOCUMENT_STATUS CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_DOCUMENT_STATUS(
	eid  VARCHAR2(12)  NOT NULL ,
	stage  char(4)  NULL ,
...
DROP TABLE B_SCOPUS_AUTHOR_KEYWORD CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_AUTHOR_KEYWORD(
	author_keyword_seq  INT  NOT NULL ,
	eid  VARCHAR2(12)  NOT NULL ,
	keyword  VARCHAR2(255)  NOT NULL
);

DROP TABLE B_SCOPUS_INDEX_KEYWORD CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_INDEX_KEYWORD(
	eid  VARCHAR2(12)  NOT NULL ,
...
/*
 * 한번 구축후 계속 사용.
DROP TABLE B_SCOPUS_ASJC CASCADE CONSTRAINTS PURGE; 
CREATE TABLE B_SCOPUS_ASJC(
...
DROP TABLE B_SCOPUS_CLASSIFICATION_ASJC CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_CLASSIFICATION_ASJC(
	eid  VARCHAR2(12)  NOT NULL ,
	asjc_code  CHAR(4)  NOT NULL
);

DROP TABLE B_SCOPUS_AUTHOR CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_AUTHOR(
...
/* 저자 정보 새로운 스키마 */
DROP TABLE B_SCOPUS_AUTHOR_ID_INFO CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_AUTHOR_ID_INFO(
	eid  VARCHAR2(12)  NOT NULL ,
...
/* 검색을 위한 테이블 */
DROP TABLE B_SCOPUS_AUTHOR_SEARCH CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_AUTHOR_SEARCH(
	author_id  VARCHAR2(12)  NULL ,
...
/*
 * 한번 구축후 계속 사용.
DROP TABLE B_SCOPUS_Country_Code CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_Country_Code(
...
DROP TABLE B_SCOPUS_CORRESPOND_AUTHOR CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_CORRESPOND_AUTHOR(
	eid  VARCHAR2(12)  NOT NULL ,
	author_seq  INT  NOT NULL ,
...
DROP TABLE B_SCOPUS_CITATION CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_CITATION(
	eid  VARCHAR2(12)  NOT NULL ,
	cit_eid  VARCHAR2(12)  NOT NULL
);

DROP TABLE B_SCOPUS_REFERENCE CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_REFERENCE(
	eid  VARCHAR2(12)  NOT NULL ,
...
DROP TABLE B_SCOPUS_Affilation_Group CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_Affilation_Group(
    eid  VARCHAR2(12)  NOT NULL ,
    group_sequence  INT  NOT NULL ,
...
DROP TABLE B_SCOPUS_Author_Group CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_Author_Group(
	eid  VARCHAR2(12)  NOT NULL ,
	group_sequence  INT  NOT NULL ,
	author_seq  INT  NOT NULL ,
	ranking  VARCHAR2(5)  NULL
...
DROP TABLE B_SCOPUS_CLASSIFICATION_OTHERS CASCADE CONSTRAINTS PURGE;
CREATE TABLE B_SCOPUS_CLASSIFICATION_OTHERS(
	eid  VARCHAR2(12)  NOT NULL ,
